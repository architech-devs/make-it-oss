...
This document describes a comprehensive scoring system for evaluating whether a software repository is "open source ready." The system is based on GitHub community standards, industry best practices, and academic research on open source software maturity models.
...
**Example Scoring:**
- Minimal README with all sections: 25 × 0.5 = 12.5 points
- Good README with detailed examples: 25 × 1.0 = 25 points
- Excellent README with tutorials: 25 × 1.2 = 30 points (capped at base)
...
- Clear guidelines → more quality contributions
...
**Calculation Example:**
- Basic CONTRIBUTING (150 total words): 5+5+3+2 = 15 × 1.0 = 15 points
- Sparse CONTRIBUTING (80 words): 15 × 0.5 = 7.5 points
...
| Recently Updated | 2 | Last update ≤60 days |
...
**Example:**
- README with 300 words: 25 × 0.5 = 12.5 points
- README with 2000 words: 25 × 1.0 = 25 points
- README with 8000 words: 25 × 1.0 = 25 points (capped at base)
...
```
weighted_score = Σ(category_percentage × category_weight × 100)
                for all categories

# Example calculation:
documentation%:  (30/35) × 0.35 × 100 = 30%
community%:      (20/25) × 0.25 × 100 = 20%
legal%:          (18/20) × 0.20 × 100 = 18%
management%:     (10/15) × 0.15 × 100 = 10%
maintenance%:    (4/5)  × 0.05 × 100 = 4%
...
3. **Contributor Interviews:** Informal discussions with OSS maintainers
4. **Academic Literature:** Review of OSMM and maturity models
